# PERF-013 | sort on collections.all.productsCategory:

**Category:** Performance

**Severity:** 🔴 CRITICAL

**Affects:** Any template applying `| sort` or `| sort_natural` to the global product catalog or large collections — typically found in search results, collection filters, or custom "all products" displays
...
- [Shopify — `sort` filter](https://shopify.dev/docs/api/liquid/filters/sort)
- [Shopify — Collection sorting and filtering](https://shopify.dev/docs/storefronts/themes/architecture/collection)
- [Shopify — Performance: Avoid collections.all.products](https://shopify.dev/docs/storefronts/themes/best-practices/performance)
- [Shopify — Dawn theme: sort filter](https://github.com/Shopify/dawn/blob/main/sections/product-grid.liquid)
